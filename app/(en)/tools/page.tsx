...
export default function ToolsPage(){
  return <main className="tool-page">
    ...
    <section className="tools-directory" aria-labelledby="available-tools"><div className="directory-heading"><p className="section-number">AVAILABLE NOW</p><h2 id="available-tools">Choose the analysis that matches the question</h2></div><div className="live-tools-grid"><Link className="tool-directory-card featured" href="/tools/word-frequency-counter"><div><span>01 · LIVE</span><h3>Word Frequency Counter</h3><p>Count every word in pasted text or a URL. Search and sort the full vocabulary, edit stop words, and export CSV or JSON.</p></div><strong>Open tool →</strong></Link><Link className="tool-directory-card featured density-card" href="/tools/keyword-density-checker"><div><span>02 · LIVE</span><h3>Keyword Density Checker</h3><p>Measure words, bigrams, and trigrams, track exact phrases, and compare density changes between result A and B.</p></div><strong>Open tool →</strong></Link><Link className="tool-directory-card featured bow-card" href="/tools/bag-of-words-analyzer"><div><span>03 · LIVE</span><h3>Bag of Words Analyzer</h3><p>Inspect vocabulary, bigrams, tracked phrases, and Zipf distribution, then save result A and compare it with result B.</p></div><strong>Open tool →</strong></Link><Link className="tool-directory-card featured comparison-card" href="/tools/text-analysis-comparison"><div><span>04 · LIVE</span><h3>Text Analysis Comparison</h3><p>Compare two texts or webpages by length, vocabulary, normalized word and bigram frequency, and Zipf diagnostics.</p></div><strong>Open tool →</strong></Link></div></section>
