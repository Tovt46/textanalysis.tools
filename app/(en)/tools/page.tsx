...
export default function ToolsPage(){
  return <main className="tool-page">
    ...
    <section className="tools-directory" aria-labelledby="available-tools"><div className="directory-heading"><p className="section-number">AVAILABLE NOW</p><h2 id="available-tools">Choose the table that matches the task</h2></div><div className="live-tools-grid"><Link className="tool-directory-card featured" href="/tools/word-frequency-counter"><div><span>01 · LIVE</span><h3>Word Frequency Counter</h3><p>Count every word in pasted text or a URL. Search and sort the full vocabulary, edit stop words, and export CSV or JSON.</p></div><strong>Open tool →</strong></Link><Link className="tool-directory-card featured density-card" href="/tools/keyword-density-checker"><div><span>02 · LIVE</span><h3>Keyword Density Checker</h3><p>Measure words, bigrams, and trigrams, track exact phrases, and compare density changes between result A and B.</p></div><strong>Open tool →</strong></Link></div></section>
