...
const description="Use the free Text Analysis Tools API to analyze keyword frequency, bigrams, focus phrases, and Zipf distribution or compare two texts and webpages.";
