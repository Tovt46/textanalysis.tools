...
const COPY={
  ru:{
    ...
    developerEye:"АВТОМАТИЗАЦИЯ",developerTitle:"Те же методы для кода, терминала и AI-агентов",developerText:"Используйте публичный JSON API, восемь локальных npm-команд или read-only MCP tools.",api:"Документация API",cli:"Документация CLI",agents:"Интеграции для AI-агентов",breadcrumb:"Навигационная цепочка",live:"РАБОТАЕТ",guide:"ГАЙД",publicApi:"ПУБЛИЧНЫЙ · БЕЗ КЛЮЧА",
  },
  uk:{
    ...
    developerEye:"АВТОМАТИЗАЦІЯ",developerTitle:"Ті самі методи для коду, термінала й AI-агентів",developerText:"Використовуйте публічний JSON API, вісім локальних npm-команд або read-only MCP tools.",api:"Документація API",cli:"Документація CLI",agents:"Інтеграції для AI-агентів",breadcrumb:"Навігаційний ланцюжок",live:"ПРАЦЮЄ",guide:"ГАЙД",publicApi:"ПУБЛІЧНИЙ · БЕЗ КЛЮЧА",
  },
  es:{
    ...
    developerEye:"AUTOMATIZACIÓN",developerTitle:"Los mismos métodos para código, terminal y agentes de IA",developerText:"Usa la API JSON pública, ocho comandos npm locales o tools MCP de solo lectura.",api:"Documentación de la API",cli:"Documentación de CLI",agents:"Integraciones para agentes de IA",breadcrumb:"Migas de pan",live:"ACTIVA",guide:"GUÍA",publicApi:"PÚBLICA · SIN CLAVE",
  },
